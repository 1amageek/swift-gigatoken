...
swiftly run swift +6.3.1 ++ build \
  ...
  --product swift-gigatoken-smoke
node --no-warnings "$root_directory/Scripts/run-wasi.mjs" \
  "$wasm_scratch/wasm32-unknown-wasip1/release/swift-gigatoken-smoke.wasm"
...
swiftly run swift +6.3.1 ++ build \
  ...
  --product swift-gigatoken-smoke
node --no-warnings "$root_directory/Scripts/run-wasi.mjs" \
  "$embedded_scratch/wasm32-unknown-wasip1/release/swift-gigatoken-smoke.wasm"
